...
/* ── helpers ─────────────────────────────────────────────────────────────── */
/** A section is usable unless the server said available:false. Successful sections omit the key. */
export function isAvailable(s: Unavailable | null | undefined): boolean {
